...
export default function TerminalPreloader() {
  ...
  useEffect(() => {
    const conf = {
      welcomeText: "Welcome to Cvacore Technologies",
      minShowMs: 1400,
      ...
      <div className="preloader" ref={preloaderRef}>
        ...
        <div className="crt">
          ...
          <div className="chrome">
            ...
            <span className="title">Cvacore®️ Secure Console</span>
          </div>
          <div className="mark">
            ...
            <strong>CVACORE TECHNOLOGIES</strong>
          </div>
          ...
          <div className="badges">
            <span className="badge">secure link: cvacore://core</span>
        ...
        >
          ...
          >
            <h1 style={{ margin: "0 0 10px", color: "#baffbf" }}>
              Welcome to Cvacore Technologies
            </h1>
